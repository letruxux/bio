  ...
  return (
    <div className="p-6 rounded-lg text-white max-w-[1024px]">
      ...
      <div ref={socialRef} className="grid grid-cols-4 gap-4">
        <a
          className="bg-blue-bg py-2 rounded-lg hover:bg-blue-hl transition hover:rotate-3"
        ...
        <a
          className="bg-blue-bg py-2 rounded-lg hover:bg-blue-hl transition text-center hover:-rotate-3"
